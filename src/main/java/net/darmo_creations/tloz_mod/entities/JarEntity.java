...
public class JarEntity extends PickableEntity {
  ...
  private static final DataParameter<Boolean> BREAK_INSTANTLY = EntityDataManager.createKey(JarEntity.class, DataSerializers.BOOLEAN);
  ...
  public JarEntity(World world, double x, double y, double z, boolean breakInstantly, PlayerEntity picker) {
    super(ModEntities.JAR.get(), world, x, y, z, true, picker);
  ...
  protected void playBreakSoundAndAnimation() {
    this.world.playSound(this.getPosX(), this.getPosY(), this.getPosZ(), SoundEvents.BLOCK_GLASS_BREAK, SoundCategory.BLOCKS,
        1, (this.world.rand.nextFloat() - this.world.rand.nextFloat()) * 0.2F * 0.7F, false);
